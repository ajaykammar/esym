...
import { Data, Biology_Data } from "../Data/Data";
...
const Biology: React.FC = () => {
  ...
  const UserNavigete = (simulation: any) => {
    if (Object.keys(JSON.parse(user)).length > 0) {
      Navigate(
        `/simulation/biology/${simulation?.title.split(" ").join("-")}/${
          simulation?.id
        }`
      );
    } else {
  ...
  return (
    <>
      <Helmet>
        <title>
          Biology Virtual Labs – 3D Biology Simulations | MantrixLab
        </title>

        <meta
          name="description"
          content="Explore interactive 3D biology simulations at MantrixLab. Perform virtual experiments on cells, organs, anatomy, physiology, DNA, genetics, and more. Perfect for school, college, and medical students."
        />

        {/* OG Tags */}
        <meta property="og:title" content="Biology Virtual Labs – MantrixLab" />
        <meta
          property="og:description"
          content="Interactive 3D biology simulations for anatomy, cells, physiology, and medical education."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://mantrixlab.com/biology" />
          ...
          {`
      {
        ...
        "@type": "CollectionPage",
        "name": "Biology Virtual Labs – MantrixLab",
        "url": "https://mantrixlab.com/biology",
        "description": "A complete library of interactive 3D biology simulations including anatomy, cells, genetics, physiology, and medical science for students.",
        "provider": {
          "@type": "Organization",
          "name": "MantrixLab",
        ...
        "about": {
          ...
          "educationalRole": "Students, Teachers, Medical Learners"
        },
        "hasPart": [
          ${Biology_Data.map((item: any) => {
            return `{
              "@type": "Course",
              "name": "${item.title}",
              "description": "${item.description}",
              "url": "https://mantrixlab.com/simulation/biology/${item.title
                .split(" ")
                .join("-")}/${item.id}",
      ...
      <>
        <div className="sketchfab-embed-wrapper">
          <iframe
            ...
            web-share="true"
            src="https://sketchfab.com/models/0b132b125c66462b86d426729df14b33/embed"
            width="100%"
            height="480"
          ></iframe>
          <p
        ...
        <div className="mx-auto p-12 pb-20 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Biology_Data &&
              Biology_Data?.map((simulation: SimulationItem) => {
