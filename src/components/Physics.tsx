...
import { Physics_Data } from "../Data/Data";
...
const Physics: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Physics Virtual Labs – 3D Physics Simulations | MantrixLab
        </title>

        <meta
          name="description"
          content="Explore interactive 3D physics simulations at MantrixLab. Learn force, motion, electricity, magnetism, waves, energy, mechanics, and more with immersive virtual labs."
        />

        {/* Open Graph */}
        <meta property="og:title" content="Physics Virtual Labs – MantrixLab" />
        <meta
          property="og:description"
          content="Interactive 3D physics simulations covering mechanics, electromagnetism, waves, energy, and scientific experiments."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://mantrixlab.com/physics" />
          ...
          {`
      {
        ...
        "@type": "CollectionPage",
        "name": "Physics Virtual Labs – MantrixLab",
        "url": "https://mantrixlab.com/physics",
        "description": "A library of interactive 3D physics simulations including mechanics, electricity, magnetism, waves, energy, and force experiments.",
        ...
        "about": {
          ...
          "educationalRole": "School Students, College Students, Physics Teachers"
        },

        "hasPart": [
          ${Physics_Data.map((item: any) => {
            return `{
              "@type": "Course",
              "name": "${item.title}",
              "description": "${item.description}",
              "url": "https://mantrixlab.com/simulation/physics/${item.title
                .split(" ")
                .join("-")}/${item.id}",
      ...
      <>
        ...
        <div className="mx-auto p-12 pb-20 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Physics_Data &&
              Physics_Data?.map((simulation: SimulationItem) => {
